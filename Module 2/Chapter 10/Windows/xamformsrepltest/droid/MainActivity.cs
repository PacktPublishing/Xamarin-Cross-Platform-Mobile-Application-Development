...
namespace XamFormsReplTest.Droid
{
	[Activity (Label = "XamFormsReplTest.Droid", Icon = "@drawable/icon", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
